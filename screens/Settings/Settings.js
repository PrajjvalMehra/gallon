    ...
    <SafeAreaView style={{ height: "100%" }}>
      ...
      <View
        style={[
          styles.container,
          {
            backgroundColor: colorMode === "light" ? "#f5f5f5" : "black",
          },
        ]}
      >
        {/* <Button
        ...
        <Button
          ...
          variant="unstyled"
          onPress={() => {
            setActionElement(<Notifications goal={goal} onClose={onClose} />);
            onOpen();
          }}
          background={"white"}
          width={"50%"}
        ...
        >
          <Text
            color={textColor}
            style={[styles.modifyGoalText, { fontSize: getFontSize(15) }]}
          >
            Alerts{"              "}
            <Pressable>
              <Feather
      ...
      >
        <Animated.View style={{ width: "100%", bottom: bottomAni }}>
          <Actionsheet.Content
            backgroundColor={colorMode === "dark" ? "primary.900" : "white"}
          >
